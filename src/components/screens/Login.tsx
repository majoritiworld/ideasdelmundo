...
export default function Login() {
  ...
  return (
    <section className="mx-auto flex min-h-screen w-full max-w-3xl flex-col items-center justify-center px-5 py-8 text-center sm:px-8">
      ...
      <h1 className="mt-10 font-['Cormorant_Garamond',serif] text-[38px] leading-tight font-medium text-[#0F1B2D] sm:text-[52px]">
        {t("title")}
      </h1>
      ...
      <button
        ...
        className="mt-8 text-sm text-[#7B8FA8] underline underline-offset-4 transition-colors hover:text-[#5A6B82]"
      >
        {t("skip")}
      </button>
    </section>
